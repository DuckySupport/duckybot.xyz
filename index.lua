...
http.request(function(success, response) if success and response and response.data then elements.version.textContent = response.data.version end end, "GET", "https://api.duckybot.xyz")
